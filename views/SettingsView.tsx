            ...
            <div className="flex-1 overflow-y-auto pb-12">
                ...
                {user?.role === 'ADMIN' && (
                    <>
                        ...
                        <SettingItem icon="admin_panel_settings" label="Painel de Controle" color="text-[#D4AF37]" onClick={() => alert('Abrindo painel mestre...')} />
                        <SettingItem icon="analytics" label="Métricas Globais" color="text-[#D4AF37]" onClick={() => alert('Carregando relatórios...')} />
                    </>
                )}
